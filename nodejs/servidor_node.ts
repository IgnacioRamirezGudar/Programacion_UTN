...
const index = require('./public/frontend/clases/test.js');
...
const path_archivo = "../archivos/neumaticos.json";
...
//LISTAR
app.get('/neumaticos_lista', (request:any, response:any)=>{
...
//Agregar
app.get('/neumatico', (request:any, response:any) =>{
